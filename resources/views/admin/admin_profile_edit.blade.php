          ...
          <div class="card-body">
            ...
            <form action="">
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input name="name" class="form-control" type="type" value="{{ $editData->name }}"
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input name="email" class="form-control" type="type" value="{{ $editData->email }}"
                    id="example-search-input">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input name="username" class="form-control" type="type" value="{{ $editData->username }}"
                    id="example-search-input">
                </div>
              </div>
              ...
              <input type="submit" class="btn btn-info waves-effect waves-light" value="Update Profile" name="" id="">
            </form>
